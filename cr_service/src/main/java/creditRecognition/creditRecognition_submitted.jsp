...
<html>
  <head>
	...
	<script type="text/javascript" src="../../js/creditRecognition/creditRecognition_submitted.js"></script>
	
	<!-- 引入layui.css -->
	<link rel="stylesheet" href="../../../webjars/layui/2.5.7/css/layui.css" media="all" />
	<!-- 引入creditRecognition_input.js -->
	<link rel="stylesheet" href="../../css/creditRecognition/creditRecognition_submitted.css" media="all" />
...
<div class="div_body">
	...
	<form class="layui-form" action="creditRecognition_input.jsp">
		<div class="div_fieldset">
		    <fieldset class="layui-elem-field">
		        <legend>认定表详情</legend>
		        
					<div class="div_table">
		                <table class="layui-hide" id="table_credit_submitted" lay-filter="test"></table>
			        ...
			        <div class="div_span">
			            <span>已提交认定修读课程共{{ n }}门，预计获得学分为{{ s }}分</span>
			        </div>
	     ...
	     <div class="div_button">
	         <button class="layui-btn layui-btn-primary layui-btn-radius" id="" lay-submit >取消提交</button>
	     </div>
      </form>         
</div>
