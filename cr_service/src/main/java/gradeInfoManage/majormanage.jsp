		  		...
		  		<blockquote class="layui-elem-quote news_search">
					...
					<div class="layui-inline">
				        ...
				        <!-- <button type="button" class="layui-btn layui-btn-warm layui-btn-radius" id="">新建年级</button>-->
				         ...
				         <div class="layui-input-inline">
					         <input type="text" class="layui-input" placeholder="例如：SOF" autocomplete="off" name="" id=""/>
					     </div>
					     <label class="layui-form-label l1">填写专业名称：</label>
			  			 <div class="layui-input-inline">
					         <input type="text" class="layui-input" placeholder="例如：软件工程" autocomplete="off" name="tno" id="" />
					     </div>
				     </div>

					 <button type="button" class="layui-btn layui-btn-warm layui-btn-radius">添加专业</button>
